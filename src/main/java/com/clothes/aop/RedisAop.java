...
import com.clothes.common.annotation.annotation.RedisCache;
import com.clothes.common.exception.JcException;
import com.clothes.common.utils.RedisUtil;
...
public class RedisAop {
     ...
     */
    @Pointcut("@annotation(com.clothes.common.annotation.annotation.RedisCache)")
    public void redisCache(){}

    /**
     *  给所有业务的数据的插入，更新，删除设置切点
     */
    @Pointcut("execution(* com.clothes.modules.*.service..*.insert*(..)) || " +
              "execution(* com.clothes.modules.*.service..*.batch*(..)) || " +
              "execution(* com.clothes.modules.*.service..*.update*(..)) || " +
              "execution(* com.clothes.modules.*.service..*.delete*(..))" )
